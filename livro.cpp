...
void Livro::setKeywords(std::vector<string> m_keysWords)
{
...
for (string it : livro.escritores)
	...
	out << " Titulo:  " << livro.titulo << endl;
	out << " Capitulos: ";
for (string it : livro.capitulos)
	{
		out << it << " " << endl;
	}
	out << "Ano de publicacao: " << livro.anoPublicaao << endl;
	out << "Idioma Original: " << livro.idiomaOriginal << endl;
	out << " Chaves: ";
